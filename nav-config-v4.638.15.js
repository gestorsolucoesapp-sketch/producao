/* Rioplastic v4.638.15 — áreas configuráveis + letreiro encostado no cabeçalho */
(function(){
  'use strict';
  ...
  function moverLetreiro(){
    const topo=$('topoFixo'), let=$('letreiroNav'), nav=topo&&topo.querySelector('nav');
    if(topo&&let&&nav&&let.nextElementSibling!==nav) topo.insertBefore(let,nav);
  }
