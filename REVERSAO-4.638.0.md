# Organização visual 4.638.0 — reversão
...
3. Usar uma **nova versão**, por exemplo 4.638.1, nos três pontos: APP_VER, selo e CACHE. Não republicar simplesmente o número antigo, pois o cache do PWA precisa atualizar.
